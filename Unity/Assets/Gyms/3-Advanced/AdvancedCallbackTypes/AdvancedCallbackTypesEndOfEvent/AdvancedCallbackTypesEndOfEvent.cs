...
public class AdvancedCallbackTypesEndOfEvent : MonoBehaviour
{
	[SerializeField]
	TextMesh m_CallbackText;

	protected static string ms_EndOfEventString = "Event has reached its end";
