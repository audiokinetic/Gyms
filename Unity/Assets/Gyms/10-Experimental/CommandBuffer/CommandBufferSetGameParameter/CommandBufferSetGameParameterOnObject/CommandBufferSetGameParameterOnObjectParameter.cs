...
public class CommandBufferSetGameParameterOnObjectParameter : MonoBehaviour
{
    ...
    [SerializeField] AK.Wwise.RTPC _rtpcClass;
    ...
    void Process(bool raise)
    {
        ...
        Wwise.AkCommandBuffer.Manager.Instance.SetRtpc(_rtpcClass.Id, _pitchValue, gameObject);
    }
}
