...
namespace Tests
{
    public class AdvancedCallbackTypesEndOfEventTests : GymTests
    {

		const string SceneName = "AdvancedCallbackTypesEndOfEvent";
        private AdvancedCallbackTypesEndOfEventTests_Callback callbackScript;

        [UnityTest]
        public IEnumerator AdvancedCallbackTypesEndOfEvent_Tests()
        {
