...
namespace Tests
{
    public class AdvancedEventsPostAndWaitTests : GymTests
    {
        const string SceneName = "AdvancedEventsPostAndWait";
        [UnityTest]
        public IEnumerator AdvancedEventsPostAndWait_Tests()
        {
            ...
            //Post Event while one is waiting for completion. The Playing ID should not increase.
            gameObject.GetComponent<AdvancedEventsPostAndWait_WaitForEndOfEvent>().Interact();
