...
class WWISEGYMSTESTRECONCILE_API FWwiseGymsTestReconcileImpl : public FWwiseGymsReconcileImpl
{
protected:
	virtual bool ShouldBeSkipped(const FWwiseReconcileItem& Item) const override;
